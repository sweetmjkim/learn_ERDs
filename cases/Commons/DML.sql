...
select 'CarInforSearch','CarInfor Search',1,NULL,NULL,'CarInfor Search','System_Code_Yes','Yes',NULL,'UUID-2222-1111111',now(),'UUID-1111-1111111',now() from dual union all 
select 'YEAR','per YEAR',1,NULL,NULL,'Using CarInfor','System_Code_Yes','Yes','CarInforSearch','UUID-1111-1111111',now(),'UUID-2222-1111111',now() from dual union all 
select 'CAR_NAME','per CAR_NAME',2,NULL,NULL,'Using CarInfor','System_Code_Yes','Yes','CarInforSearch','UUID-1111-1111111',now(),'UUID-2222-1111111',now() from dual union all 
